...
char no_broadcast(char * packet);
char crc_ok(char * packet);
char address_check(char * packet);
char no_ack_msg(char *packet);
void send_ack(char * packet);
